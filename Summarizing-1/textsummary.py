...
text = """The chicken (Gallus domesticus) is a large and round short-winged bird, domesticated from the red junglefowl of Southeast Asia around 8,000 years ago. Most chickens are raised for food, providing meat and eggs; others are kept as pets or for cockfighting.
...
def summarizer(rawdocs):
    ...
    # print(text)
    # print(summary)
    # print("Lenghth of original document:", len(text.split()))
